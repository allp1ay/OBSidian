...
> - [@ntchff](https://t.me/ntchff) овелей, программу obs_sp.exe, которая позволяет запускать OBS по выбранному сочетанию клавиш и Link&Autostart.exe для создания ярлыка.
