...
>[!example]- Изменения
>**OBS (Max.mov v0.8.1exp)**
>1. Новый способ установки
>2. Новый оверлей от @ntchff
>3. Изменения и дополнения в инструкции, связанные с оверлеем.
...
> - [@ntchff](https://t.me/ntchff) за программу obs_sp.exe которая позволяет запускать OBS по выбранному сочетанию клавиш, установщик, оверлей и многое другое.
